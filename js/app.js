    ...
    <div class="page-inner">
      ...
      <div class="about-section">
        ...
        <div class="about-section-body">
          <h3>عن المبادرة</h3>
          <p>مبادرة تعليمية تفاعلية تُعنى بتنمية مهارات القراءة والفهم القرائي لدى طلاب الصف السادس الابتدائي، استعدادًا للاختبارات الوطنية (نافس). نفّذها معلمو اللغة العربية في ابتدائية الإمام عاصم لتحفيظ القرآن الكريم بمحافظة شقراء، تحت إشراف ومتابعة مدير المدرسة، وبمشاركة مشرف نواتج التعلم في مجال اللغة العربية.</p>
        </div>
      </div>
